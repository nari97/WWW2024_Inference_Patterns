...
public class AMIERuleParser {

    String filename = null;
    String model_name = null;
    String dataset_name = null;
    String relationship_delimiter = "\t";
    String database_folder = null;
    Map<String, List<Rule>> rules_by_predicate;
    List<Rule> rules;
    Map<String, String> id_to_relationship;


    public AMIERuleParser(String filename){
        this.filename = filename;
        this.rules_by_predicate = new HashMap<>();
        this.rules = new ArrayList<>();
    }

    public AMIERuleParser(String filename, String database_folder, String model_name, String dataset_name, String relationship_delimiter) throws FileNotFoundException {
        this.filename = filename;
    ...
    public void parse_rules_from_file(double beta) throws FileNotFoundException {
        ...
        for(int ctr=15; ctr<num_lines-3; ++ctr){
            ...
            double sc_conf = Double.parseDouble(splits[2]);
            ...
            Rule rule = new Rule(head_atom, body_atoms, hc, pca, sc_conf, functional_variable, beta);
    ...
    public List<Atom> create_body_from_rule(String rule){
        ...
        for(int i=0; i< body_atom_end_index; ++i){
            ...
            String variable1 = atom_string.substring(atom_string.indexOf("(")+1, atom_string.indexOf(",")).replace("?", "");
            String variable2 = atom_string.substring(atom_string.indexOf(",")+1, atom_string.indexOf(")")).replace("?", "");
